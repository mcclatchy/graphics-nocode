...
const SampleArticle = (props) => {
    ...
    const noInlineSizeNames = ['audio-control', 'scrolling-map', 'inset-box', 'lottie-box']
            ...
            <div className="flag">
                <div className="flag-row flag-top">
                    ...
                    <div className="flag-account">
                        <div id="brz_envelope_container">
                          <div id="brz_unread_icon" style={{display:"none", height: "25px", marginTop: "2px", width: "25px"}}>
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 576 512">
                              <defs>
                              </defs>
                              <circle className="brz_unread_circle" fill="#fe0606" cx="496" cy="80" r="80"></circle>
                              <path className="brz_envelope" d="M48,64h337.1c-.7,5.2-1.1,10.6-1.1,16,0,45.6,27.2,84.8,66.3,102.3l-175.1,131.3c-11.4,8.5-27,8.5-38.4,0L19.2,150.4C7.1,141.3,0,127.1,0,112c0-26.5,21.5-48,48-48Z"></path>
                              <path className="brz_envelope" d="M294.4,339.2l196.4-147.3c1.7.1,3.4.1,5.2.1,5.4,0,10.8-.4,16-1.1v193.1c0,35.3-28.7,64-64,64H64c-35.3,0-64-28.7-64-64v-208l217.6,163.2c22.8,17.1,54,17.1,76.8,0h0Z"></path>
                            </svg>
                          </div>

                          <div id="brz_read_icon" style={{display: "block", height: "22px", width: "22px"}}>
                            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 512 512">
                              <path className="brz_envelope" d="M48,64C21.5,64,0,85.5,0,112s7.1,29.3,19.2,38.4l217.6,163.2c11.4,8.5,27,8.5,38.4,0l217.6-163.2c12.1-9.1,19.2-23.3,19.2-38.4,0-26.5-21.5-48-48-48,0,0-416,0-416,0ZM0,176v208c0,35.3,28.7,64,64,64h384c35.3,0,64-28.7,64-64v-208l-217.6,163.2c-22.8,17.1-54,17.1-76.8,0L0,176Z"></path>
                            </svg>
                          </div>
                        </div>
    ...
    <div id="promo-banner"></div>
        ...
        <article className="paper story-body" >
            {nonBodyWebComponents && nonBodyWebComponents.map((webComponent, i) => {
                ...
                return (
                  <div style={{width: "100%", maxWidth: "100vw", position: "relative", padding: 0, margin: 0, height: 0}} key={i} >
              ...
              {bodyWebComponents && bodyWebComponents.map((webComponent, i) => {
                ...
                return (
                  <Fragment key={`fragment-${i}`}>
                    <div style={{position: 'relative', maxWidth: "100%", padding: 0, height: 0, containerType: noInlineSizeNames.includes(webComponent.props.name) ? "" : "inline-size"}} key={i}>
                      {cloneElement(toolbar, { key: toolbar.id })}
                    </div>
                    <WebComponent
                        name={webComponent.props.name}
